...
static int camera_start_recording(struct camera_device *device)
{
    ...
    if (CAMERA_ID(device) == BACK_CAMERA_ID) {
        ...
        parameters.set("picture-size", "3200x2400");
    }
...
static char *camera_get_parameters(struct camera_device *device)
{
    ...
    if (CAMERA_ID(device) == BACK_CAMERA_ID) {
        ...
        params.set(CameraParameters::KEY_SUPPORTED_PREVIEW_SIZES,
            "1920x1080,1280x960,1280x720,960x720,864x480,800x480,768x432,720x480,640x480,576x432,480x320,384x288,320x240,240x160,176x144");
        params.set(CameraParameters::KEY_SUPPORTED_VIDEO_SIZES,
            "1920x1080,1280x960,1280x720,864x480,800x480,720x480,640x480,480x320,352x288,320x240,176x144");
        params.set(CameraParameters::KEY_SUPPORTED_PICTURE_SIZES,
            "3200x2400,3264x1836,2592x1944,2048x1536,1920x1080,1600x1200,1280x960,1280x768,1280x720,1024x768,800x600,800x480,720x480,640x480,352x288,320x240,176x144");
    } else if (CAMERA_ID(device) == FRONT_CAMERA_ID) { 
        /* Inject all supported resolutions */
        params.set(CameraParameters::KEY_SUPPORTED_VIDEO_SIZES,
            "1280x960,1280x720,864x480,800x480,720x480,640x480,480x320,352x288,320x240,176x144");
    }
